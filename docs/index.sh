...
show_help() {
    ...
    echo ""
    echo -e "${BRIGHT_BLUE}Tmux Navigation${NC}"
    echo -e "  ${WHITE}Ctrl+B${NC} then ${WHITE}Arrow Keys${NC}  Navigate between panes"
    echo -e "  ${WHITE}Ctrl+B${NC} then ${WHITE}O${NC}           Cycle through panes"
    echo -e "  ${WHITE}Ctrl+B${NC} then ${WHITE};${NC}           Toggle between current/previous pane"
    echo ""
