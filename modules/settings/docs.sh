...
show_settings_help() {
    ...
    echo -e "  ${BRIGHT_GREEN}[a]${NC} add workspace      Create a new workspace"
    echo -e "  ${BRIGHT_GREEN}[m]${NC} manage workspace   Add, edit, or remove projects from a workspace"
    echo -e "  ${BRIGHT_PURPLE}[b]${NC} back              Return to main menu"
    echo -e "  ${BRIGHT_PURPLE}[h]${NC} help              Show this help screen"
    echo ""

    echo -e "${BRIGHT_CYAN}What are Workspaces?${NC}"
    ...
    echo -e "${BRIGHT_CYAN}Workflow:${NC}"
    echo -e "  1. Add a workspace using ${BRIGHT_GREEN}[a]${NC}"
    echo -e "  2. Select the workspace to manage using ${BRIGHT_GREEN}[m]${NC}"
